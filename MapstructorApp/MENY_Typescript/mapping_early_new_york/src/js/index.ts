...
function setLayoutVisibilityForBothMaps(id: any, status: any): void{
...
var modal_header_text: any[] = [];
var modal_content_html: any[] = [];
...
//#endregion
  ...
  $("#grants_layer_items").change(function () {
    $(".grants_layer").prop("checked", (this as HTMLInputElement).checked);
    if ($(this).prop("checked")) {
  ...
  $("#native_groups_layer_items").change(function () {
    $(".native_groups_layer").prop("checked", (this as HTMLInputElement).checked);
    if ($(this).prop("checked")) {
      [
        "native-groups-area",

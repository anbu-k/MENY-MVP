  ...
  if (renderedEntity) {
    ...
    if (props.popUpProps.type === "long-island-native-groups") {
      return (
        <div id="rightInfoBar" className="rightInfoBarBorder">
          <div
            className="infoLayerElem"
            id="infoLayerNativeGroups"
      ...
      return (
        <div id="rightInfoBar" className="rightInfoBarBorder">
          <div className="infoLayerElem" id="infoLayerDutchGrants">
            ...
            <b>Dutch Grant Lot:</b>
            <a
              href="https://encyclopedia.nahc-mapping.org/lots/grantlotFort Amsterdam"
              target="_blank"
            >
              Fort Amsterdam
            </a>
            ...
            <i>
              <a
                target="_blank"
                href="https://nahc-mapping.org/mappingNY/encyclopedia/node/3277"
              >
                DWIC - Corporation - Dutch West India Company (DWIC)
              </a>
            </i>
            <br />
            <br />
            <br />
            <img
              src="https://encyclopedia.nahc-mapping.org/sites/default/files/2022-02/Fort%20Amsterdam%20warm%201%20mg%201650%20Len%20Tantillo_0.jpg"
              width="258"
            ></img>
            <br />
            <br />
      ...
      return (
        <div id="rightInfoBar" className="rightInfoBarBorder">
          <div className="infoLayerElem" id="infoLayerDutchGrants">
            ...
            <b>Start:</b>{" "}
            <i>
              {props.popUpProps.day1} {props.popUpProps.year1}
            </i>
            <br />
            <b>End:</b>{" "}
            <i>
              {props.popUpProps.day2} {props.popUpProps.year2}
            </i>
            <br />
            <br />
            <b>Description (partial):</b>
            <br />
            {props.popUpProps.descriptio}
            <br />
            <br />
          </div>
        </div>

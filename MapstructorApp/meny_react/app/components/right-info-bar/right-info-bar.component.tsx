...
import InfoLayerGrantLots from './info-layer-grant-lots/info-layer-grant-lots';
import { InfoLayerGrantLotsProps } from '@/app/models/info-layer/info-layer-grant-lots.model';
import { InfoLayerDutchGrantsProps } from '@/app/models/info-layer/info-layer-dutch-grants.model';
import { InfoLayerNativeGroupsProps } from '@/app/models/info-layer/info-layer-native-groups.model';
import { InfoLayerCastelloProps } from '@/app/models/info-layer/info-layer-castello.model';
import { InfoLayerDemoProps } from '@/app/models/info-layer/info-layer-demo.model';

const RightInfoBar = () => {
    const [grantLotsInfo, setGrantLotsInfo] = useState<InfoLayerGrantLotsProps | null>(null);
    const [dutchGrantsInfo, setDutchGrantsInfo] = useState<InfoLayerDutchGrantsProps | null>(null);
    const [nativeGroupsInfo, setNativeGroupsInfo] = useState<InfoLayerNativeGroupsProps | null>(null);
    const [castelloInfo, setCastelloInfo] = useState<InfoLayerCastelloProps | null>(null);
    const [demoInfo, setDemoInfo] = useState<InfoLayerDemoProps | null>(null);

    return (
        <>
            <div id ='rightInfoBar' className= 'rightInfoBarBorder'>
                {(grantLotsInfo !== null) && <InfoLayerGrantLots name={''} Lot={''} day1={''} day2={''} year1={''} year2={''} description={''}/>}
                {(dutchGrantsInfo !== null) && <InfoLayerGrantLots name={''} Lot={''} day1={''} day2={''} year1={''} year2={''} description={''}/>}
                {(nativeGroupsInfo !== null) && <InfoLayerGrantLots name={''} Lot={''} day1={''} day2={''} year1={''} year2={''} description={''}/>}
                {(castelloInfo !== null) && <InfoLayerGrantLots name={''} Lot={''} day1={''} day2={''} year1={''} year2={''} description={''}/>}
                {(demoInfo !== null) && <InfoLayerGrantLots name={''} Lot={''} day1={''} day2={''} year1={''} year2={''} description={''}/>}
            </div>
        </>
    );

import {
  ...
  SectionLayerGroup,
  SectionLayerItem,
} from "@/app/models/layers/layer.model";
          ...
          <FontAwesomeIcon
            ...
            icon={
              props.group.items.length > 0
                ? getFontawesomeIcon(props.group.iconType, props.group.isSolid)
                : layerIsOpen
                ? getFontawesomeIcon(FontAwesomeLayerIcons.PLUS_SQUARE, true)
                : getFontawesomeIcon(FontAwesomeLayerIcons.MINUS_SQUARE, true)
            }
            style={{
              color:
                props.group.items.length > 0
                  ? IconColors.GREY
                  : props.group.iconColor,
            }}
          />{" "}
          {props.group.label}
